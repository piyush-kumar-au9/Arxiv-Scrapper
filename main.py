...
try:
    ...
    # Loading the driver
    driver = webdriver.Chrome("C:/Users/Piyush/Downloads/chromedriver_win32/chromedriver.exe")
    ...
    Adv_search = driver.find_element_by_xpath('//*[@id="header"]/div[2]/form/div/div[1]/p/a[2]')
    Adv_search.click()
    ...
    search = driver.find_element_by_xpath('//*[@id="main-container"]/div[2]/div[2]/div[1]/div/form/section[3]/button')
    search.click()
